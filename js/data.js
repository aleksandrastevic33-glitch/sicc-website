var SICC_PRODUCTS = [
  /* ── Pendants ─────────────────────────────── */
  {
    ...
    tactile:
      "Small raised dots along the outer edge of the circle. Run your thumb over them. Stick-and-poke energy. Satisfying.",
    tryOnNote: "Camera opens. Hold pendant against your chest. We won't watch.",
    altText:
      "Kolo pendant, solid. Silver circle on white background. Dots around the edge.",
    images: ["images/products/kolo-pendant-solid-1.png"],
...

  {
    ...
    size: "Pendant diameter 2.5cm.",
    tactile:
      "Raised dots around the solid areas. Your thumb jumps between steel and space. A rhythm.",
    tryOnNote:
      "Camera opens. See how light passes through. Or don't. We're not forcing you.",
    altText:
      "Kolo pendant, open. Silver circle with cutouts. White background. Dots on the remaining steel.",
    images: ["images/products/kolo-pendant-open-1.png"],
  ...
  /* ── Earrings ─────────────────────────────── */
  {
    ...
    tactile:
      "Dots along each edge. Run your finger from point to point. Each dot is a poke. Each poke is a decision.",
    tryOnNote:
      "Camera opens. Hold near your ear. Try not to look too intimidating.",
    altText:
      "Trokut earrings. Small. Three sharp edges. Silver. Dots on the surface. White background.",
    images: ["images/products/trokut-earrings-1.png"],
...

  {
    ...
    tactile:
      "Each ball has a single dot. Count them. There are many. A meditation in steel.",
    tryOnNote: "Camera opens. Prepare for weight. Good weight.",
    altText:
      "Kuglice earrings. Large. Silver balls connected by rods. White background. Chunky.",
    images: ["images/products/kuglice-earrings-1.png"],
  ...
  /* ── Rings (no ear) ────────────────────────────────── */
  {
    ...
    tactile:
      "Dots stamped in a ring around the entire band. Spin it on your finger. Stim for hours. We won't tell anyone.",
    tryOnNote:
      "Camera opens. Put it on your finger. Make a fist. Feel something.",
    altText:
      "Kolo ring, masculine. Thick silver band. Dots all around. White background.",
    images: ["images/products/kolo-ring-masc-1.png"],
...

  {
    ...
    tactile:
      "Dots stamped around the band – smaller than the masculine version, but they're there. Run your thumb in circles. Calming.",
    tryOnNote: "Camera opens. Try it. Spin it. See if it fits your energy.",
    altText:
      "Kolo ring, feminine. Thin silver band. Small dots. White background. Lighter but not weak.",
    images: ["images/products/kolo-ring-fem-1.png"],
  ...
  /* ── Choker O.0  ───────────────────────────────── */
  {
    ...
    materials:
      "Recycled stainless steel. Handmade in Croatia. Interlocking rings.",
    size: "Length 38cm (standard choker). Extender chain to 42cm.",
    tactile:
      "Each small ring has a dot. Hundreds of them. Run your fingers across your neck. A secret text nobody else can read.",
    tryOnNote:
      "Camera opens. Wrap it around your neck. Feel like royalty. Steel royalty.",
    altText:
      "Mreža choker. Silver net of rings. White background. Looks like pearls from far away. It's not.",
    images: ["images/products/mreza-choker-1.png"],
  ...
  /* ── Septums ──────────────────────────────── */
  {
    ...
    tactile:
      "Dots on each half-circle – three per curve. Run your fingertip along the bottom. Up one curve, down the next. A pattern.",
    tryOnNote: "Camera opens. Hold near your nose. Pretend it's already there.",
    altText:
      "Polukrug septum. Three silver half-circles connected. White background. Dots on each curve.",
    images: ["images/products/polukrug-septum-1.png"],
...

  {
    ...
    tactile:
      "Dots along the rounded edge. None on the sharp point. That's just for show – or for pressing. Your choice.",
    tryOnNote: "Camera opens. Don't poke yourself. We warned you.",
    altText:
      "Suza septum. Tear drop shape. Sharp point at the end. Silver. White background.",
    images: ["images/products/suza-septum-1.png"],
...
function getFeaturedProducts() {
  return SICC_PRODUCTS.filter(function (p) {
    return p.featured;
  }).slice(0, 3);
}
