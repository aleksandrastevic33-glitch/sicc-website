...
var SICC_LANG = (function () {
  try {
    return localStorage.getItem("sicc-lang") || "en";
  } catch (e) {
    return "en";
  }
})();
...
var SICC_I18N = {
  ...
  en: {
    ...
    /* Home */
    home_brand1_html:
      "Sicc is not another jewelry brand.<br>It's not a souvenir. It's not a trend.<br>It's not trying to be your friend.",
    home_brand2: "Old symbols. Recycled steel. No apologies.",
    home_featured: "Selected pieces",
    home_interlude2_html:
      "Sicanje is a centuries-old tradition of protective tattooing. Catholic women in the Balkans marked their skin with circles, crosses, spirals. Not for decoration. For <strong>protection</strong>. Identity. Prayer.",
    home_cta_h2_html: "Every piece<br>means something.",
    home_cta_p:
      "Nine pieces. Each one a symbol. Each one stainless steel. Each one made in Croatia.",
    ...
    about_s1_p1:
      "Before the ink, there was the symbol. Sicanje is the traditional tattoo practice of Catholic women in the Balkans – Croatia, Bosnia, Herzegovina. For centuries, they marked their hands, fingers, chests, and necks with protective symbols: crosses, circles, spirals, lines.",
    about_s1_p2:
      "Not decoration. Protection. Identity. Prayer. The practice nearly disappeared. Then it came back. Now it's on your jewelry.",
    about_s2_h2: "What we do",
    about_s2_p:
      "We take those old symbols – the ones your grandmother wore – and cast them in recycled stainless steel. Same symbols. New material. No needle. No pain. No fading.",
    about_s3_h2: "The dots",
    about_s3_p1:
      "Every piece of Sicc jewelry has small raised dots. They're not random. They're a nod to the stick-and-poke technique – the original way Sicanje tattoos were made. Dot by dot. Poke by poke.",
    about_s3_p2: "Touch them. Fidget with them. That's the point.",
    about_s4_h2: "Sustainability",
    about_s4_p1:
      "Recycled steel. Local hands. No bullshit. We don't greenwash. We don't need to. Recycled materials cost more. We pay it anyway. Local production takes longer. We wait anyway.",
    about_s4_p2:
      "You want fast fashion? Go elsewhere. You want symbols that last? You're in the right place.",
    about_s5_h2: "The name and tagline",
    about_s5_p1:
      "Sicc is pronounced “sick.” It’s short for Sicanje. It also means cool, awesome, badass. Both apply.",
    about_s5_p2:
      "from skin to skin. The symbols traveled from traditional tattooed skin to yours. Via steel. No needle required.",
    about_symbols_h2: "The symbols.",

    about_symbols: [
      {
        name: "Circle (kolo)",
        meaning: "No beginning. No end. Protection. That's it.",
      },
      {
        name: "Cross (križ)",
        meaning:
          "Not just Christian. Older than that. Sun. Stars. Four directions. Balance.",
      },
      {
        name: "Spiral (spirala)",
        meaning: "Movement. Life. Growth. Not standing still.",
      },
      {
        name: "Ball (lopta)",
        meaning:
          "Unity. Community. Coming together. Also looks good on a ring.",
      },
      {
        name: "Lines (crte)",
        meaning:
          "Boundaries. Protection. Keeping things in. Keeping things out.",
      },
      {
        name: "Triangle (trokut)",
        meaning: "Sharp. Three points. Warning. Or just a nice shape.",
      },
      {
        name: "Tear (suza)",
        meaning: "Sadness? Maybe. Sharpness? Definitely.",
      },
      {
        name: "Net (mreža)",
        meaning: "Connection. Interlocking. We're all linked.",
      },
    ],
    ...
    contact_send: "Send",
    contact_note:
      "We'll reply. Might take a day or two. We're busy making steel things.",
    ...
    notfound_p:
      "Neither were half our ancestors at some point. Displaced. Lost. Wandering. They figured it out. So can you.",
    ...
    checkout_payment_note:
      'Secure payment processing coming soon. For now, contact us directly at <a href="mailto:hello@sicc.com">hello@sicc.com</a> to complete your order.',
    ...
    tryon_hint:
      "Tap anywhere on the camera view to place the jewelry. Scroll or pinch to resize.",
  ...
  hr: {
    ...
    /* Home */
    home_brand1_html:
      "Sicc nije još jedan brend nakita.<br>Nije suvenir. Nije trend.<br>Ne pokušava biti tvoj prijatelj.",
    home_brand2: "Stari simboli. Reciklirani čelik. Bez isprika.",
    home_featured: "Odabrani komadi",
    home_interlude2_html:
      "Sicanje je stoljetna tradicija zaštitnog tetoviranja. Katoličke žene na Balkanu označavale su svoju kožu krugovima, križevima, spiralama. Ne radi dekoracije. Radi <strong>zaštite</strong>. Identiteta. Molitve.",
    home_cta_h2_html: "Svaki komad<br>nešto znači.",
    home_cta_p:
      "Devet komada. Svaki jedan simbol. Svaki od nehrđajućeg čelika. Svaki napravljen u Hrvatskoj.",
    ...
    about_s1_p1:
      "Prije tinte, postojao je simbol. Sicanje je tradicionalna praksa tetoviranja katoličkih žena na Balkanu – u Hrvatskoj, Bosni i Hercegovini. Stoljećima su označavale ruke, prste, grudi i vrat zaštitnim simbolima: križevima, krugovima, spiralama, linijama.",
    about_s1_p2:
      "ne radi dekoracije. radi zaštite. radi identiteta. radi molitve. praksa je zamalo nestala. potom se vratila. sad je na tvojem nakitu.",
    about_s2_h2: "Što radimo",
    about_s2_p:
      "Uzimamo te stare simbole – one koje je nosila tvoja baka – i lijevamo ih u reciklirani nehrđajući čelik. Isti simboli. Novi materijal. Bez igle. Bez boli. Bez blijeđenja.",
    about_s3_h2: "Točkice",
    about_s3_p1:
      "Svaki komad Sicc nakita ima male izbočene točkice. Nisu slučajne. Odraz su stick-and-poke tehnike – izvornog načina na koji su se izrađivale Sicanje tetovaže. Točka po točka. Ubod po ubod.",
    about_s3_p2: "dodirni ih. igraj se s njima. to je poanta.",
    about_s4_h2: "Održivost",
    about_s4_p1:
      "reciklirani čelik. lokalne ruke. bez zajebancije. ne prodajemo priču o održivosti. ne trebamo. reciklirani materijali koštaju više. svejedno plaćamo. lokalna proizvodnja traje dulje. svejedno čekamo.",
    about_s4_p2:
      "Hoćeš brzu modu? Idi drugdje. Hoćeš simbole koji traju? Na pravom si mjestu.",
    about_s5_h2: "Ime i slogan",
    about_s5_p1:
      "sicc se čita “sick”. skraćenica je za sicanje. znači i kul, super, odlično. oboje je primjenjivo.",
    about_s5_p2:
      "od kože do kože. Simboli su putovali s tradicionalne tetovane kože na tvoju. Putem čelika. Bez igle.",
    about_symbols_h2: "Simboli.",
    about_symbols_note:
      "Ima ih još. Još istražujemo. Dodati ćemo ih kad budemo sigurni.",
    about_symbols: [
      {
        name: "Krug (kolo)",
        meaning: "Nema početka. Nema kraja. Zaštita. To je to.",
      },
      {
        name: "Križ (križ)",
        meaning:
          "Nije samo kršćansko. Starije od toga. Sunce. Zvijezde. Četiri strane svijeta. Ravnoteža.",
      },
      {
        name: "Spirala (spirala)",
        meaning: "Kretanje. Život. Rast. Ne stajati na mjestu.",
      },
      {
        name: "Lopta (lopta)",
        meaning:
          "Jedinstvo. Zajednica. Dolaženje zajedno. I lijepo izgleda na prstenu.",
      },
      {
        name: "Crte (crte)",
        meaning:
          "Granice. Zaštita. Zadržavati stvari unutra. Zadržavati stvari vani.",
      },
      {
        name: "Trokut (trokut)",
        meaning: "Oštro. Tri točke. Upozorenje. Ili samo lijep oblik.",
      },
      { name: "Suza (suza)", meaning: "Tuga? Možda. Oštrina? Definitivno." },
      {
        name: "Mreža (mreža)",
        meaning: "Veza. Isprepletenost. Svi smo povezani.",
      },
    ],
    ...
    contact_note:
      "Odgovorit ćemo. Može potrajati dan-dva. Zauzeti smo izradom čeličnih stvari.",
    ...
    notfound_p:
      "Ni pola naših predaka nije postojalo negdje u jednom trenutku. Raseljeni. Izgubljeni. U lutanju. Smislili su kako. I ti možeš.",
    ...
    checkout_payment_note:
      'Sigurna obrada plaćanja uskoro stiže. Za sada nas kontaktirajte izravno na <a href="mailto:hello@sicc.com">hello@sicc.com</a> za dovršetak narudžbe.',
    ...
    tryon_hint:
      "Tapkaj bilo gdje na prikazu kamere za postavljanje nakita. Skrolaj ili štipni za promjenu veličine.",
    ...
    products: {
      "kolo-pendant-solid": {
        ...
        tactile:
          "Male izbočene točkice duž vanjskog ruba kruga. Prevuci palcem. Energija stick-and-poke. Zadovoljavajuće.",
        altText:
          "Kolo privjesak, puni. Srebrni krug na bijeloj pozadini. Točkice oko ruba.",
      },
      "kolo-pendant-open": {
        ...
        size: "Promjer privjeska 2.5cm.",
        tactile:
          "Izbočene točkice na punim dijelovima. Palac skače između čelika i prostora. Ritam.",
        altText:
          "Kolo privjesak, otvoreni. Srebrni krug s izrezima. Bijela pozadina. Točkice na preostalom čeliku.",
      },
      "trokut-earrings": {
        ...
        tactile:
          "Točkice duž svakog ruba. Prevuci prstom od točke do točke. Svaka točkica je ubod. Svaki ubod je odluka.",
        altText:
          "Trokut naušnice. Male. Tri oštra ruba. Srebrne. Točkice na površini. Bijela pozadina.",
      },
      "kuglice-earrings": {
        ...
        tactile:
          "Svaka kuglica ima jednu točkicu. Broji ih. Ima ih mnogo. Meditacija u čeliku.",
        altText:
          "Kuglice naušnice. Velike. Srebrne kuglice spojene šipkama. Bijela pozadina. Glomazne.",
      },
      "kolo-ring-masculine": {
        ...
        tactile:
          "Točkice utisnute u prsten oko cijelog pojasa. Vrti ga na prstu. Stimuliraj satima. Nećemo nikome reći.",
        altText:
          "Kolo prsten, muški. Debeli srebrni pojas. Točkice unaokolo. Bijela pozadina.",
      },
      "kolo-ring-feminine": {
        ...
        tactile:
          "Točkice utisnute oko pojasa – manje od muške verzije, ali tu su. Vrtuljaj palcem u krug. Smirujuće.",
        altText:
          "Kolo prsten, ženski. Tanki srebrni pojas. Male točkice. Bijela pozadina. Lakši ali ne slab.",
      },
      "mreza-choker": {
        name: "Mreža Ogrlica",
        ...
        materials:
          "Reciklirani nehrđajući čelik. Ručno izrađeno u Hrvatskoj. Isprepleteni prsteni.",
        size: "Duljina 38cm (standardna ogrlica). Lančić za produženje do 42cm.",
        tactile:
          "Svaki mali prsten ima točkicu. Stotine njih. Prevuci prstima po vratu. Tajni tekst koji nitko drugi ne može čitati.",
        altText:
          "Mreža ogrlica. Srebrna mreža prstena. Bijela pozadina. Izgleda kao biseri izdaleka. Nije.",
      },
      "polukrug-septum": {
        ...
        materials:
          "Reciklirani nehrđajući čelik. Ručno izrađeno u Hrvatskoj. Hipoalergeno.",
        size: "Širina 1.5cm. Visi 2.5cm od nosa.",
        tactile:
          "Točkice na svakom polukrugu – tri po luku. Prevuci vrškom prsta po dnu. Gore jednim lukom, dolje sljedećim. Uzorak.",
        altText:
          "Polukrug septum. Tri spojena srebrna polukruga. Bijela pozadina. Točkice na svakom luku.",
      },
      "suza-septum": {
        name: "Suza Septum",
        ...
        tactile:
          "Točkice duž zaobljenog ruba. Nijedna na oštrom vrhu. To je samo za show – ili za pritiskanje. Tvoj izbor.",
        altText:
          "Suza septum. Oblik suze. Oštar vrh. Srebrna. Bijela pozadina.",
      },
    },
  },
};
...
function pt(product, field) {
  if (SICC_LANG === "hr") {
    ...
    if (
      hrProds &&
      hrProds[product.id] &&
      hrProds[product.id][field] !== undefined
    ) {
...
function setLang(lang) {
  SICC_LANG = lang;
  try {
    localStorage.setItem("sicc-lang", lang);
  } catch (e) {}
  updateStaticText();
